...
export class Decorations {
  ...
  private readonly lowDeco:      vscode.TextEditorDecorationType;
  ...
  applyDetections(
    ...
    anchor:     vscode.Selection | vscode.Range,
    ...
    for (const d of detections) {
      ...
      switch (d.severity) {
        case 'CRITICAL': criticalRanges.push(options); break;
        case 'HIGH':     highRanges.push(options);     break;
        case 'MEDIUM':   mediumRanges.push(options);   break;
        case 'LOW':      lowRanges.push(options);      break;
      }
    }
